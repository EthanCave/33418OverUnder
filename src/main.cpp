  ...
  while(auto_started == false){            //Changing the names below will only change their names on the
    ...
    switch(current_auton_selection){       //Tap the brain screen to cycle through autons.
      ...
      case 1:
        ...
        break;  
      case 2:
        Brain.Screen.printAt(50, 50, "Left Side");
        break;
      case 3:
        Brain.Screen.printAt(50, 50, "Right Side");
        break;
      case 4:
...
void autonomous(void) {
  ...
  switch(current_auton_selection){  
    case 0:
      ...
      break;     
    case 1:
      drive_test(); //Change these to be your own auton functions in order to use the auton selector.
      break;     
    case 2:
      left_side();
      break;     
...
void usercontrol(void) {
  ...
  while (1) {
    Controller1.ButtonR2.pressed(retract);
    Controller1.ButtonR2.released(out);

    Controller1.ButtonL2.pressed(launch);
    Controller1.ButtonL2.released(stopLaunch);
